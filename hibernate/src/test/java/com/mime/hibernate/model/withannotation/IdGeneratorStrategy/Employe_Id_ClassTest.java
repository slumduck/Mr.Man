...
import com.mime.hibernate.model.withannotation.IdGeneratorStrategy.Employe_IdClass_PK;

public class Employe_Id_ClassTest {
	...
	@Test
	public void testSaveEmploye_IdClass(){
		Employe_IdClass ps = new Employe_IdClass();
        ps.setName("meimei");
	...
	@Test
	public void testSelectEmploye_IdClass(){
		Session session = sessionFactory.openSession();
        Query query = session.createQuery("from Employe_IdClass");
        @SuppressWarnings("unchecked")
		List<com.mime.hibernate.model.withannotation.IdGeneratorStrategy.Employe_IdClass> list = query.list();
        for(com.mime.hibernate.model.withannotation.IdGeneratorStrategy.Employe_IdClass tea:list){
